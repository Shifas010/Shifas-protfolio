...
function Home() {
 ...
 const [HiButtoncolor,setHibuttoncolor]=useState(true)
  ...
  return (
    <div className='main w-full h-screen md:h-1/2 lg:h-screen items-center bg-black p-4 md:flex text-white relative'>
      <div className=" w-full md:w-1/2 md:h-full h-1/2  overflow-hidden relative flex ">
        ...
        <div className="borderBoxC w-[100px] h-[50px] lg:w-[150px] md:h-[100px] lg:h-[150px] bottom-1 md:bottom-14 rounded-[20px] mt-[30%]  bg-red-500 z-10 absolute flex  overflow-hidden">
        </div>
      ...
      <div className=" w-full md:w-1/2  md:h-full p-4 md:mt-24 "> 
        <div className="w-full h-5/6  md:h-4/6  flex ">
          <div className="w-5/6 h-full lg:p-[60px] font-bold ">
            ...
            <div className="w-full items-center flex   h-2/6 md:h-1/6   ">
             ...
             <div className="lg:h-/6  w-full flex pt-[50px]">
              <div className="w-1/2  h-full  items-center flex"><button  className={HiButtoncolor?`w-[100px] lg:w-[150px] h[30px] lg:h-[50px] bg-red-500`:"w-[150px] h-[50px]" }>Say Hi</button></div>
              <div className="w-1/2 h-full items-center flex  "><button className={AboutmeButtoncolor?`w-[100px] lg:w-[150px] h[30px] lg:h-[50px] bg-red-500`:"w-[100px] lg:w-[150px] h[30px] lg:h-[50px]"}>Say Hi</button></div>
             </div>
          ...
          <div className="social p-4 w-1/6 h-full items-center lg:flex justify-start ">
            <ul>
              <li className='mt-4 bg-transparent'><img src={whatsup} alt="" /></li>
              <li className='mt-4 bg-transparent'><img src={instagram} alt="" /></li>
              <li className='mt-4 bg-transparent'><img src={linkedin} alt="" /> </li>
              <li className='mt-4 bg-transparent'><img src={twitter} alt="" /></li>
              
            </ul>

          </div>
        </div>
        <div className="w-full none h-1/6 justify-start  md:justify-end p-4 flex items-center"> <div className="mail text-xs md:text-sm"> shifaskottayi@gmail.com</div></div>
         </div>
